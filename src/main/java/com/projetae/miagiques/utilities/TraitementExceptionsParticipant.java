...
public class TraitementExceptionsParticipant {
    ...
    public ResponseEntity<String> gererParticipantException(HttpServletRequest requete, BilletInexistant ex) {
    ...
    public ResponseEntity<String> gererParticipantInexistant(HttpServletRequest requete, BilletInexistant ex) {
